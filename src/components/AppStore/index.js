...
class AppStore extends Component {
  ...
  getFilter = () => {
    ...
    const filterApps = appsList.filter(app => app.category === activeTabId)
    return filterApps
  }
  ...
  searchResults = () => {
    ...
    const filteredSearchResults = appsList.filter(app =>
  ...
  render() {
    ...
    const filteredSearchResults = this.searchResults()
    const filterApps = this.getFilter(filteredSearchResults)
